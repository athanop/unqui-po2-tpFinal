...
import ar.edu.unq.po2.BusquedaProyecto.FiltroPorCategoriaExclusion;

class FiltroPorCategoriaExclusionTestCase {

	private FiltroPorCategoriaExclusion filtro;
	...
	void setUp() throws Exception {
		...
		categorias.add(cat1);
		categorias.add(cat3);
		filtro = new FiltroPorCategoriaExclusion(categorias);
	}
	
	@Test
	void testFiltroSeExcluyenLasCategorias() {
		assertFalse(filtro.filtrados(proyectos).contains(proy1));
		assertTrue(filtro.filtrados(proyectos).contains(proy2));
