...
class ORCompositeTestCase {
	...
	void setUp() throws Exception {
		...
		orc = new ORComposite(filtro1, filtro2);
	...
	@Test
	void testORComposite() {
		assertTrue(orc.filtrados(proyectos).contains(proy1));
		assertFalse(orc.filtrados(proyectos).contains(proy2));
		assertTrue(orc.filtrados(proyectos).contains(proy3));
	}
